...
import { restaurantClass } from '../../constants/restaurantClass.js';
...
const handleCardClick = (ScenicSpotID) => {
  ...
  const url = `/restaurantDetail/${selectedId.value}`;
  // 跳轉至對應 id 頁面
    ...
    <div class="row py-4 d-flex">
      ...
      <div class="col-lg-3 mb-3">
        <select class="form-select" v-model="selectedActive">
          ...
          <option
            v-for="restaurantClass in restaurantClass"
            :value="restaurantClass.name"
            :key="restaurantClass.name"
          >
            {{ restaurantClass.name }}
          </option>
        </select>
      </div>
    ...
    <div v-if="!search">
      ...
      <div class="card-wrap row">
        <div
          ...
          v-for="active in restaurantClass"
          :key="active.name"
        >
          <div class="card-img">
    ...
    <div v-if="search">
      ...
      <div class="row" v-if="citiesCount > 0">
        <div
          ...
          :key="index"
          @click="handleCardClick(active.RestaurantID)"
        >
          ...
          <div class="card-body">
            <div class="card-title">{{ active.RestaurantName }}</div>
            <div class="text-muted">
              ...
              <span
                ...
                ><i class="bi bi-tag"></i
              ></span>
              <span class="active-class" v-if="active.Class"
                ># {{ active.Class }}</span
              >
            </div>
          </div>
