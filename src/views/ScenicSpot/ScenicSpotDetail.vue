...
<template>
  <div class="detail container p-5" v-for="scenicSpot in scenicSpotData" :key="scenicSpot">
    <!-- 麵包屑 -->
    <nav aria-label="breadcrumb" class="py-2 mt-3">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item">
          ...
          >
          {{
              scenicSpot.Class1 ? scenicSpot.Class1 : scenicSpot.Class2 ? scenicSpot.Class2 : ''
            }}</router-Link>
        </li>
    ...
    <div class="active-wrap">
      ...
      <div class="active-class-wrap" v-if="scenicSpot.Class1 || scenicSpot.Class2">
      ...
      <div class="row mt-4">
        <div class="col-lg-6">
          <div class="bg-light border-radius p-4 mb-5">
            ...
            <div class="active-description-title">
              服務電話：<span>{{ scenicSpot.Phone ? scenicSpot.Phone : '無' }}</span>
            </div>
            <div class="active-description-title">
              景點地址：<span>{{
                scenicSpot.Address
            ...
            <div class="active-description-title">
              官方網站：<a :href="scenicSpot.WebsiteUrl">
                <span>{{ scenicSpot.WebsiteUrl ? scenicSpot.WebsiteUrl : '無' }}</span></a
              >
            </div>
            <div class="active-description-title">
              票價資訊：<span>{{
            ...
            <div class="active-description-title">
              注意事項：<span>{{ scenicSpot.Remarks ? scenicSpot.Remarks : '無' }}</span>
            </div>
          </div>
        </div>
